...
public class AdtMessageFactory {
    ...
    public static Message createMessage(String messageType, String name, String numProcesso, String adress, int idPedido, String exame, String codigo, String estadoPedido) throws HL7Exception, IOException {

        //This patterns enables you to build other message types
        if ( messageType.equals("001") )
        {
            return new MessageBuilder().Build(name, numProcesso, adress, idPedido, codigo, exame, estadoPedido);
        }
